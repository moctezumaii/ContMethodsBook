...
This will be updated with the final schedule once I assign presentation dates. Here is the general plan:
...
| **Feedback assistant** | Collects all feedback and data from the Scribe |
