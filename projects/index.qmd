---
title: "Final Paper: Project Home"
format: html
---

This is your **living project guide**. You will return to it every week to update your timeline, document your method decisions, and track your progress. The sections below walk you through the full project workflow from setup to final paper.

::: {.callout-tip}
## Workshop Rhythm

Every Thursday workshop begins with a **10-minute self-assessment**. Use [Weekly Self-Assessment](weekly-self-assessment.html) 
:::

---

## Upcoming: Brief Progress Presentations

Next week, you will give a **3–5 minute progress update** during Thursday workshop time. 

See [Progress Presentation Instructions](progress-presentation.html) for what to prepare and bring.

::: {.callout-important}
## Before next Thursday's workshop

⬜ Update your Expected Timeline in your README  
⬜ Push your latest code or analysis to GitHub  
⬜ Add or update your Methods section (at least two sentences)  
⬜ Have your assumption check table present (even if incomplete)  
⬜ Identify one open question you want feedback on
...
## Step 7: Start working on your methods
I wante everyone to do "one concrete" thing this week, aimed at analyzing your data. This could be a code chunk that runs a model, creates a figure, or produces a table. It can be cleaning data. We are at the half point of the semester, so, this is where you should be.
...
:::{.callout-important}
By the end of this week your project should look like this example (obviously with more detail and specific to your project)!
:::
...
## Step 8: Run preliminary analyses

At this point you should be runnign your preliminary analyses and having one r file with your analyses! You should share it.
