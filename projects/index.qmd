...
Every Thursday workshop begins with a **10-minute self-assessment**. Use [Weekly Self-Assessment](weekly-self-assessment.html) to structure that check-in. Update your README on GitHub as you go — that is how your instructor can see your progress.
:::
...
Starting **next week**, each student will give a **3–5 minute progress update** during Thursday workshop time. This is informal — no slides required. You will briefly describe where you are, show one thing from your project, and name one open question.
