...
Your final paper is the capstone of this course. It brings together everything we have worked on this semester — from the Method-Question-Data Triangle (Week 3), to method justification and assumption checking (Weeks 5–9), to your own research question and data.
...
Submit your paper by pushing the final version to your GitHub repository and notifying me via email. Make sure the repository is shared with me (see Step 4 in the [Project Home](index.html) page).
:::
...
1. **A written paper** in your GitHub repository. The paper can be a `.qmd`, `.Rmd`, `.docx`, or `.pdf` file — whatever your target journal would accept, but I strongly encourage you to use Quarto or R Markdown for reproducibility.
2. **All code and data** (or a clear description of how to obtain the data) needed to reproduce your analysis, pushed to your GitHub repository.
3. **A README** in your repository that includes your research question, variables, analysis method, assumption check table, and expected timeline (you should already have this from earlier in the semester — update it as needed).
...
- State your **research question** explicitly and early.
- Provide enough background for the reader to understand why the question matters.
- I encourage brevity here — a focused introduction is better than a long one. Think 1–2 paragraphs for a course paper, unless your target journal expects more.
- End the introduction with a clear statement of your objective or hypothesis.
...
| **Reproducibility & Code** | Code and data are available in the GitHub repository. Analysis can be reproduced by running the code. Software and package versions are reported. | Code is present but incomplete or not fully reproducible. | No code is shared, or code does not run. | 10% |
...
| **May 10, 2026** | **Final paper due** — push to GitHub and email me |

Your presentation date is **not** the same as your paper due date. You should be working on your paper continuously — do not wait until after your presentation to start writing.
