...
1. **Part 1 (≈35 min): Week 3 Simulation Refresher** - We'll work through the simulations that many of you found challenging last week. We do this together, step by step, so everyone is comfortable with simulating data, fitting the wrong model, and fitting the correct model.

2. **Part 2 (≈35 min): Git on Top of Your Simulations** - Once your code is working, we'll use *that same code* to practice Git. You'll create a repository, make commits at each stage of the analysis, and see how version control tells the story of your work.
